...
async def capture(url):
    ...
    await url.edit(
        "`Menghasilkan screenshot halaman...`"
...
CMD_HELP.update(
    {
        "ss": ".ss <url>\
    \nUsage: Mengambil tangkapan layar dari situs web dan mengirimkan tangkapan layar.\
    \nContoh URL yang valid : `https://www.google.com`"
    }
)
