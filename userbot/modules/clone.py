...
async def clone(cloner):
    ...
    await cloner.edit("`Profil berhasil di-clone!`")
...
CMD_HELP.update(
    {
        "clone": ">`.clone` <balas ke pengguna>/<username>"
        "\nUsage: Mengkloning nama, foto profil, dan bio seseorang"
        "\n\n>`.revert`"
        "\nUsage: Kembali ke profil Anda"
    }
)
