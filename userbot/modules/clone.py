...
async def _(event):
    ...
    await borg.send_message(
        event.chat_id, "**Lu siapa ngab? .. **", reply_to=reply_message
    )
    if BOTLOG:
...
CMD_HELP.update(
    {
        "clone": ".clone <nama pengguna/balas>\
\nUsage: mencuri profil orang lain termasuk dp, nama.\
\n\n.revert\
\nUsage: Untuk kembali ke profil Anda tetapi ini akan menampilkan ALIVE_NAME sebagai ganti nama Anda saat ini dan DEFAULT_BIO alih-alih bio Anda saat ini\
"
    }
)
