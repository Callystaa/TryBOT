...
async def editer(edit):
    ...
    async for message in edit.client.iter_messages(chat, self_id):
        ...
        i = i + 1
    if BOTLOG:
        await edit.client.send_message(BOTLOG_CHATID, "Edit kueri berhasil dijalankan")
...
CMD_HELP.update(
    {
        "purge": ".purge\
        \nUsage: Hapus semua pesan mulai dari balasan."
    }
)
...
CMD_HELP.update(
    {
        "purgeme": ".purgeme <x>\
        \nUsage: Menghapus sejumlah x pesan terbaru Anda."
    }
)
...
CMD_HELP.update(
    {
        "del": ".del\
\nUsage: Menghapus pesan yang Anda balas."
    }
)
...
\nUsage: Ganti pesan terakhir Anda dengan <newmessage>."
    }
)
