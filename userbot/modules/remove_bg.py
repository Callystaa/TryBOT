...
async def kbg(remob):
    ...
    if remob.reply_to_msg_id:
        ...
        await remob.edit("`Menghapus latar belakang..`")
        try:
            if isinstance(
...
CMD_HELP.update(
    {
        "rbg": ".rbg <Tautan ke Gambar> atau balas gambar apa pun (Peringatan: tidak berfungsi pada stiker.)\
\nUsage: Menghapus latar belakang gambar, menggunakan API remove.bg"
    }
)
